...
void ActuatorsROS::update_diagnostics_topic(){
    ...
    if (this->actuator->connected) {
        ...
        sprintf(strings[2], "%07ld Ticks", this->actuator->get_position(0));
        sprintf(strings[3], "%07ld Ticks", this->actuator->get_position(1));
        sprintf(strings[4], "%07ld Ticks/s", this->actuator->get_velocity(0));
        sprintf(strings[5], "%07ld Ticks/s", this->actuator->get_velocity(1));
